...
#include <net-lwip.h>
/*
 * struct ip_hdr is defined twice:
 * 1. In $(srctree)/include/net.h
 * 2. In $(srctree)/lib/lwip/include/lwip/prot/ip4.h
 * Let's shadow one of those temporarily to avoid a compile error.
 */
#define ip_hdr u_ip_hdr
#include <net.h>
#undef ip_hdr
